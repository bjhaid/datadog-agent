...
func TestFormatPacketV1Generic(t *testing.T) {
	...
	assert.Equal(t, "snmp-traps", data["ddsource"])
	assert.Equal(t, "snmp-traps", data["ddservice"])
	assert.Equal(t, "snmp_version:1,device_namespace:default,snmp_device:127.0.0.1", data["ddtags"])
...
func TestFormatPacketToJSON(t *testing.T) {
	...
	assert.Equal(t, "snmp-traps", data["ddsource"])
	assert.Equal(t, "snmp-traps", data["ddservice"])
	assert.Equal(t, "snmp_version:2,device_namespace:default,snmp_device:127.0.0.1", data["ddtags"])
...
func TestFormatterWithResolverAndTrapV2(t *testing.T) {
	...
	assert.Equal(t, "snmp-traps", content["ddsource"])
	assert.Equal(t, "snmp-traps", content["ddservice"])
	assert.Equal(t, "snmp_version:2,device_namespace:default,snmp_device:127.0.0.1", content["ddtags"])
...
func TestFormatterWithResolverAndTrapV1Generic(t *testing.T) {
	...
	assert.Equal(t, "snmp-traps", content["ddsource"])
	assert.Equal(t, "snmp-traps", content["ddservice"])
	assert.Equal(t, "snmp_version:1,device_namespace:default,snmp_device:127.0.0.1", content["ddtags"])
